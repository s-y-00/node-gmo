...
GmoPrivate.prototype.cancelOrders = function (orderIds)
{
  return this.postQuery("/cancelOrders", {
    orderIds: orderIds,
  });
};

GmoPrivate.prototype.cancelBulkOrder = function (
  pairs,
  side,
  type,
  desc
...
{
  return this.postQuery("/cancelBulkOrder", {
    symbols: pairs,
    side: side,
    settleType: type,
    desc: desc,
...
GmoPrivate.prototype.closeBulkOrder = function (
  pair,
  price,
  side,
  type,
